...
import com.learning.marketplace.bank.DummyBank;
...
public class OrderService {
    ...
    public Order save(NewOrderRequest newOrderRequest) {
        try {
            BankOrderResponse bankOrderResponse =  restTemplate.postForEntity("http://localhost:8080/execufteOrder", newOrderRequest, BankOrderResponse.class).getBody();
